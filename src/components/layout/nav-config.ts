...
export const sections: NavSection[] = [
  {
    ...
    items: [
      ...
      { to: '/get-started/install', label: 'Install', summary: '설치, 컴포넌트 목록, AI 에이전트에게 보여주는 법', updatedAt: '2026-08-29' },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/foundations/layout', label: 'Layout', summary: '반응형 기준점, 콘텐츠 폭, Container Grid System', updatedAt: '2026-08-31' },
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          { to: '/components/stat-card', label: 'Stat Card', updatedAt: '2026-08-30' },
      ...
      },
      {
        ...
        items: [
          ...
          { to: '/components/chart-radial', label: 'Chart Radial', updatedAt: '2026-08-29' },
        ],
      },
      {
        label: 'Feedback',
