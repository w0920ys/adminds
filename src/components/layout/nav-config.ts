...
export const sections: NavSection[] = [
  {
    ...
    items: [
      ...
      { to: '/get-started/install', label: 'Install', summary: '설치와 첫 컴포넌트 붙이기', updatedAt: '2026-08-27' },
      { to: '/get-started/principles', label: 'Principles', summary: '판단이 갈릴 때 기대는 원칙', updatedAt: '2026-08-27' },
    ],
  },
  {
    id: 'foundations',
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          { to: '/components/file-upload', label: 'File Upload', updatedAt: '2026-08-26' },
      ...
      },
      {
        ...
        items: [
          ...
          { to: '/components/data-table', label: 'Data Table', updatedAt: '2026-08-28' },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/patterns/list', label: 'List', summary: '여러 항목을 훑고 걸러 하나를 고르는 화면', updatedAt: '2026-08-28' },
  ...
  },
  {
    ...
    label: 'Updates',
    to: '/updates',
    items: [{ to: '/updates', label: 'Overview', summary: '버전마다 무엇이 바뀌었는가', updatedAt: '2026-08-28' }],
  },
]
